...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { author: @tip.author, description: @tip.description, name: @tip.name, tip_category_id: @tip.tip_category_id, tip_recommendation_id: @tip.tip_recommendation_id }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { author: @tip.author, description: @tip.description, name: @tip.name, tip_category_id: @tip.tip_category_id, tip_recommendation_id: @tip.tip_recommendation_id }
    assert_redirected_to tip_path(assigns(:tip))
  end
