...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { item_id: @training.item_id, mode_id: @training.mode_id, reps: @training.reps, set: @training.set, weight: @training.weight }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { item_id: @training.item_id, mode_id: @training.mode_id, reps: @training.reps, set: @training.set, weight: @training.weight }
    assert_redirected_to training_path(assigns(:training))
  end
